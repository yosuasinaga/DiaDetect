...
with tab1:
    ...
    **DiaDetect** merupakan aplikasi **prediksi risiko diabetes** yang dikembangkan dengan pendekatan **machine learning** berdasarkan data survei kesehatan **BRFSS2015** dari CDC. Aplikasi ini dirancang untuk memberikan kemudahan bagi masyarakat dalam melakukan **deteksi dini risiko diabetes**, tanpa perlu melalui prosedur medis yang kompleks. Dengan memanfaatkan indikator kesehatan seperti **BMI**, **tekanan darah**, **kolesterol**, dan **aktivitas fisik**, aplikasi ini memberikan prediksi yang informatif guna mendorong tindakan pencegahan sedini mungkin.
    ...
    - Diperkirakan **236.711 orang** di Indonesia meninggal akibat komplikasi diabetes pada usia 20-79 tahun. [Cegah Dini Ancaman Diabetes](https://indonesia.go.id/kategori/editorial/8401/www.indonesia.go.id)
    - Prevalensi diabetes dapat meningkat menjadi **16,09%** pada 2045, dengan jumlah kasus diperkirakan mencapai **40,7 juta**. [Proyeksi Morbiditas dan Mortalitas Diabetes hingga 2045 di Indonesia](https://diabetes-indonesia.net/2024/08/proyeksi-morbiditas-dan-mortalitas-diabetes-hingga-2045-di-indonesia-berdasarkan-faktor-risiko-dan-program-pencegahan-dan-pengendalian-ptm-2/)
    - Sekitar **73,7%** penderita diabetes di Indonesia tidak terdiagnosis, sehingga tidak mendapatkan pengobatan yang tepat. [Cegah Dini Ancaman Diabetes](https://indonesia.go.id/kategori/editorial/8401/www.indonesia.go.id)
    """)
